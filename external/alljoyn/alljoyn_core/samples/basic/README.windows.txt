(note: if you don't have AllJoyn Service already running on your system these examples will not run.)

The following are samples of a basic service and client that will use the already existing AllJoyn Service to transfer messages.
    +basic_service.cc
    +basic_client.cc
