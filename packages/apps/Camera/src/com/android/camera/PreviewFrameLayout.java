...
public class PreviewFrameLayout extends RelativeLayout {
    ...
    public PreviewFrameLayout(Context context, AttributeSet attrs) {
        ...
        mFrontOrientation = false;
    }

    public void setCameraOrientation(boolean orientation){
        mFrontOrientation = orientation;
    }
	...
	if (mFrontOrientation) {
                previewHeight = (int) (previewWidth * mAspectRatio + .5);
        } else {
                previewWidth = (int) (previewHeight * mAspectRatio + .5);
        }

        if (previewWidth > originalWidth) {
                previewHeight = (int)(((double)originalWidth / (double)previewWidth) * previewHeight);
                previewWidth = originalWidth;
        } else if (previewHeight > originalHeight) {
